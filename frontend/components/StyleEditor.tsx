        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm transition-opacity p-6">
            <div className="bg-white w-[1000px] h-[85vh] rounded-2xl shadow-2xl flex flex-col animate-in zoom-in-95 duration-200 overflow-hidden">
                ...
                <div className="px-8 py-5 border-b border-zinc-100 flex justify-between items-center bg-zinc-50/80 backdrop-blur shrink-0">
                    <div>
                        <h3 className="font-bold text-xl text-zinc-900">高级排版配置</h3>
                        <p className="text-sm text-zinc-500 mt-1">当前预设: <span className="font-medium text-indigo-600">{presetTitle}</span></p>
                    </div>
                    ...
                    <div className="p-8 space-y-8">
                        ...
                        <section className="space-y-4">
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <h4 className="font-bold text-zinc-900">文档结构与编号</h4>
                            </div>

                            <div className="bg-zinc-50/50 rounded-xl border border-zinc-200/60 p-5 space-y-5">
                                <div className="max-w-md">
                                    <span className="text-xs font-bold text-zinc-500 uppercase tracking-wider block mb-2">标题自动编号风格</span>
                                    <div className="relative">
                                        <select
                            ...
                            <div className="space-y-8">
                                ...
                                <section className="space-y-4">
                                    <div className="flex items-center gap-3 mb-2">
                                        ...
                                        <h4 className="font-bold text-zinc-900">{isJournal ? '正文/标题字体' : '字体与字号'}</h4>
                                    </div>
                                ...
                                <section className="space-y-4">
                                    <div className="flex items-center gap-3 mb-2">
                                        ...
                                        <h4 className="font-bold text-zinc-900">段落间距</h4>
                                    </div>
                            ...
                            <div className="space-y-8">
                                ...
                                {isJournal && (
                                    <section className="space-y-4">
                                        <div className="flex items-center gap-3 mb-2">
                                            ...
                                            <h4 className="font-bold text-blue-900">期刊专用配置</h4>
                                        </div>
                                        ...
                                        <div className="bg-blue-50/30 p-5 rounded-xl border border-blue-100/60 space-y-4">
                                            ...
                                            <div className="pt-3 border-t border-blue-200/50">
                                                <span className="text-xs font-bold text-blue-800/70 block mb-3">摘要设置</span>
                                ...
                                <section className="space-y-4">
                                    <div className="flex items-center gap-3 mb-2">
                                        ...
                                        <h4 className="font-bold text-zinc-900">图片/插图</h4>
                                    </div>
                                    <div className="p-5 bg-zinc-50/50 rounded-xl border border-zinc-200/60 space-y-4">
                                        <div>
                                            <span className="text-xs text-zinc-500 block mb-1.5">编号模式</span>
                                            <div className="relative">
                                                <select
                                ...
                                <section className="space-y-4">
                                    <div className="flex items-center gap-3 mb-2">
                                        ...
                                        <h4 className="font-bold text-zinc-900">表格设置</h4>
                                    </div>
                                    <div className="p-5 bg-zinc-50/50 rounded-xl border border-zinc-200/60 space-y-4">
                                        <div>
                                            <span className="text-xs text-zinc-500 block mb-1.5">表格编号模式</span>
                                            <div className="relative">
                                                <select
